                      ...
                      <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="{{ route('home') }}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           Home
                            ...
                            <a class="dropdown-item" href="{{ route('home') }}">Home 2</a>
                            <a class="dropdown-item" href="{{ route('home') }}">Home 3</a>
                            <a class="dropdown-item" href="{{ route('home') }}">Home 4</a>
                            <a class="dropdown-item" href="{{ route('home') }}">Home 5</a>
                            <a class="dropdown-item" href="{{ route('home') }}">Home 6</a>
                          </div>
